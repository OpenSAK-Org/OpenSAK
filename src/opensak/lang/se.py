...
STRINGS: dict[str, str] = {
    ...
    "filter_cc_distance":           "Avstånd korrigerade ↔ ursprungliga",
    "filter_op_less_than":          "Mindre än",
    "filter_op_more_than":          "Mer än",
    "filter_op_not_between":        "Inte mellan",
    ...
    "filter_tab_waypoints":         "Underordnade waypoints",
    "filter_wp_code":               "Kod",
    "filter_wp_date":               "Datum",
    "filter_wp_comment":            "Kommentar",
    "filter_wp_by_user":            "Skapad av användare",
    "filter_wp_count":              "Antal",
    "filter_wp_count_at_least":     "Minst",
    "filter_wp_count_at_most":      "Högst",
    "filter_log_date":              "Loggdatum",
    "filter_log_scope":             "Loggar att söka i",
    "filter_log_scope_all":         "Alla loggar",
    "filter_log_scope_last_one":    "Senaste",
    "filter_log_scope_last":        "Senaste {n}",
    "filter_log_cat_other":         "Andra",
    "filter_log_include":           "Inkludera / uteslut",
    "filter_log_include_yes":       "Inkludera",
    "filter_log_include_hint":      "Tar med eller utesluter cacher där villkoren nedan stämmer",
    "filter_log_types":             "Loggtyper",
    "filter_log_types_all":         "Alla (avmarkera för att välja enskilda loggtyper)",
    "filter_log_type_other":        '"Andra" (typ ej i listan)',
    "filter_log_count":             "Krävt antal",
    "filter_log_count_any":         "Minst en logg",
    "filter_log_finder":            "Loggad av",
    "filter_log_finder_enable":     "och loggen är från en viss person",
    "filter_log_finder_by_id":      "Matcha användar-ID",
    ...
    "filter_attr_search_placeholder": "Sök attribut (namn eller ID)…",
    "filter_attr_only_selected":    "Visa endast valda",
    "filter_attr_status":           "{shown} av {total} visas · {selected} valda",
    ...
    "startup_app_control_title":    "Blockerad av Windows Smart App Control",
    "startup_app_control_msg":      "Windows Smart App Control har hindrat en del av OpenSAK från att läsas in, så OpenSAK kan inte starta.\n\nDet kan hända med den direkta nedladdningen från GitHub. Installera i stället OpenSAK från Microsoft Store (se opensak.com) — den versionen är signerad av Microsoft, blockeras inte och håller sig själv uppdaterad.\n\n{error}\n\nEn detaljerad logg har sparats här:\n{path}",
    ...
    "update_download_button":       "Ladda ner och installera",
    "update_downloading_title":     "Laddar ner uppdatering",
    "update_downloading":           "Laddar ner den nya versionen…",
    ...
    "pq_email_test_error_certificate": "✗ Serverns säkerhetscertifikat kunde inte verifieras ({detail}), så ditt lösenord skickades inte. Kontrollera att servernamnet är exakt det som din e-postleverantör anger, t.ex. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ E-postserverns säkerhetscertifikat kunde inte verifieras ({detail}), så brevlådan kontrollerades inte. Kontrollera servernamnet under Inställningar → PQ Email.",
    ...
    "action_file_locations": "OpenSAK-filplatser…",
    "file_locations_title": "OpenSAK-filplatser",
    "file_locations_intro": "OpenSAK sparar sina inställningar, databaser och andra filer på platserna nedan. När OpenSAK avinstalleras lämnas dina data normalt kvar — om du vill ta bort allt kan du själv radera dessa mappar och filer efter avinstallationen. Databaser som öppnats från andra platser visas endast som information och tas aldrig bort automatiskt.",
    "file_locations_col_contents": "Innehåll",
    "file_locations_col_location": "Plats",
    "file_locations_col_exists": "Finns",
    "file_locations_col_size": "Storlek",
    "file_locations_open_folder": "Öppna mapp",
    "file_locations_copy_all": "Kopiera allt till urklipp",
    "file_locations_kind_install_dir": "Inställningar och programdata",
    "file_locations_kind_bootstrap_dir": "Startkonfiguration (pekar på datamappen)",
    "file_locations_kind_database_dir": "Databasmapp",
    "file_locations_kind_external_database": "Databas öppnad från en annan plats",
    "file_locations_kind_qt_settings": "Äldre inställningar (kortkommandon)",
    "file_locations_kind_keyring_entry": "PQ Email-lösenord (systemets nyckelring)",
    "file_locations_kind_appimage_binary": "Programfil (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Post i programmenyn",
