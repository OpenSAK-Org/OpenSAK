...
STRINGS: dict[str, str] = {
    ...
    "search_where_placeholder":     "z. B. distance < 5",
    "search_where_tooltip":         "SQL-WHERE-Bedingung — gleiche Syntax wie der Where-Reiter im Filterdialog. Enter zum Anwenden, Feld leeren zum Entfernen. Zuletzt verwendete Ausdrücke stehen in der Liste.",
    "search_where_invalid":         "Ungültiger Where-Ausdruck: {error}",
    ...
    "toolbar_filter_combo_tooltip":  "Gespeicherten Filter wählen",
    ...
    "import_saving":               "Speichere in der Datenbank…",
    ...
    "gps_caches_ready":             "<b>{count} Caches</b> bereit für den Export (aktuell gefilterte/angezeigte Caches)",
    "gps_dest_group":               "Ziel",
    ...
    "settings_group_distance":          "Entfernungsberechnung",
    "settings_distance_method_label":   "Methode:",
    "settings_distance_haversine":      "Haversine (Groundspeak-kompatibel)",
    "settings_distance_vincenty":       "Vincenty WGS84 (höhere Genauigkeit)",
    ...
    "about_text":
        ...
        "<p>Ein Open-Source-Geocaching-Verwaltungstool "
        "für Linux, Mac und Windows.</p>"
        "<p>Erstellt mit Python und PySide6.</p>"
        "<p>Grenzdaten &copy; OpenStreetMap-Mitwirkende und GSAK, "
        "lizenziert unter <a href='https://opendatacommons.org/licenses/odbl/'>ODbL</a>.</p>"
    ...
    "wp_tab_personal":                         "Persönlich",
    "wp_cb_desc_html":                         "Enthält HTML",
    "wp_val_elevation_invalid":                "Die Höhe muss eine Zahl sein (Meter).",
    "wp_child_add":                            "Wegpunkt hinzufügen…",
    "wp_child_dialog_title_add":               "Wegpunkt hinzufügen",
    "wp_child_dialog_title_edit":              "Wegpunkt bearbeiten",
    "wp_child_col_prefix":                     "Präfix",
    "wp_child_label_prefix":                   "Präfix *:",
    "wp_child_label_comment":                  "Kommentar:",
    "wp_child_label_code":                     "Wegpunkt-Code:",
    "wp_child_label_date":                     "Datum:",
    "wp_child_cb_flag":                        "Markiert",
    "wp_child_val_prefix_required":            "Präfix ist erforderlich.",
    "wp_child_val_code_duplicate":             "Der Wegpunkt-Code {code} wird bereits von einem anderen Wegpunkt dieses Caches verwendet.",
    ...
    "update_loc_no_boundaries":     "Keine Grenzdaten verfügbar. Bitte die Daten-Pipeline ausführen, um die Grenzdatenbank zu erzeugen.",
    ...
    "db_remove_msg":                "'{name}' aus der Liste entfernen?\n\nDie Datei wird NICHT gelöscht.",
    ...
    "filter_owner_name_label":      "Besitzername:",
    ...
    "filter_tb_tracking_code":      "Tracking-Code",
    ...
    "filter_cc_distance":           "Distanz korrigiert ↔ Original",
    "filter_op_less_than":          "Weniger als",
    "filter_op_more_than":          "Mehr als",
    "filter_op_not_between":        "Nicht zwischen",
    ...
    "filter_tab_waypoints":         "Unterwegpunkte",
    "filter_wp_code":               "Code",
    "filter_wp_date":               "Datum",
    "filter_wp_comment":            "Kommentar",
    "filter_wp_by_user":            "Von Benutzer",
    "filter_wp_count":              "Anzahl",
    "filter_wp_count_at_least":     "Mindestens",
    "filter_wp_count_at_most":      "Höchstens",
    "filter_log_date":              "Logdatum",
    "filter_log_scope":             "Zu durchsuchende Logs",
    "filter_log_scope_all":         "Alle Logs",
    "filter_log_scope_last_one":    "Letzter",
    "filter_log_scope_last":        "Letzte {n}",
    "filter_log_cat_other":         "Andere",
    "filter_log_include":           "Ein-/Ausschliessen",
    "filter_log_include_yes":       "Einschliessen",
    "filter_log_include_hint":      "Schliesst Geocaches im Filter ein/aus, falls die folgenden Bedingungen zutreffen",
    "filter_log_types":             "Logtypen",
    "filter_log_types_all":         "Alle (Abwählen, um einzelne Logtypen zu wählen)",
    "filter_log_type_other":        '"Andere" (nicht gelisteter Typ)',
    "filter_log_count":             "Nötige Anzahl",
    "filter_log_count_any":         "Mindestens ein Log",
    "filter_log_finder":            "Geloggt von",
    "filter_log_finder_enable":     "und Log ist von bestimmter Person",
    "filter_log_finder_by_id":      "User-ID verwenden",
    "filter_lp_points_label":       "Linien-/Polygon-Punkte",
    "filter_lp_points_placeholder": "Breitengrad, Längengrad — ein Punkt pro Zeile, z. B.\n47.37690, 8.54170\nN 46 56.868, E 007 26.826\n\nW,GC12345 übernimmt die Koordinaten eines Caches oder Wegpunkts aus der Datenbank.\nText nach # wird ignoriert.",
    ...
    "filter_lp_description":        "Der Linienfilter wählt Caches danach aus, wie nahe sie an einer Linie liegen — einer Folge verbundener Punkte, ähnlich einer Route oder einem Track. Gib mindestens zwei Punkte und die Entfernung zur Linie an, innerhalb der Caches berücksichtigt werden.\n\nPolygon: Die Punkte umranden ein Gebiet (wird automatisch geschlossen, mindestens drei Punkte); Caches darin werden berücksichtigt. Eine Entfernung grösser 0 schliesst zusätzlich Caches in dieser Entfernung zum Rand ein.\n\nPunkte: Caches innerhalb der Entfernung zu einem der Punkte werden berücksichtigt.\n\nSetze den Haken bei «Ausschliessen», um stattdessen nur die nicht passenden Caches zu behalten. Korrigierte Koordinaten werden verwendet, sofern vorhanden.",
    ...
    "filter_lp_exclude":            "Ausschliessen",
    ...
    "filter_lp_distance_required":  "Gib für einen Linien- oder Punktefilter eine Entfernung grösser 0 ein.",
    ...
    "filter_attr_search_placeholder": "Attribute suchen (Name oder ID)…",
    "filter_attr_only_selected":    "Nur gewählte anzeigen",
    "filter_attr_status":           "{shown} von {total} angezeigt · {selected} gewählt",
    ...
    "filter_overwrite_title":       "Profil überschreiben",
    "filter_overwrite_msg":         "Das Filterprofil '{name}' existiert bereits. Überschreiben?",
    ...
    "proj_start_hint":              "Gib die Start-Koordinaten im DMM-, DMS- oder DD-Format ein",
    ...
    "trip_sort_distance":           "Entfernung (nächste zuerst)",
    "trip_sort_difficulty":         "Schwierigkeit (einfachste zuerst)",
    "trip_sort_terrain":            "Terrain (einfachste zuerst)",
    "trip_sort_hidden_date":        "Versteckdatum (neueste zuerst)",
    ...
    "trip_btn_preview_map":                    "🗺️  Auf der Karte anzeigen",
    ...
    "gc_info_group":                "Wofür wird Geocaching.com verwendet?",
    ...
    "gc_info_finds":                "Synchronisiert automatisch Ihre Funde",
    ...
    "update_download_button":       "Herunterladen & installieren",
    "update_downloading_title":     "Update wird heruntergeladen",
    "update_downloading":           "Die neue Version wird heruntergeladen…",
    ...
    "pq_email_test_error_certificate": "✗ Das Sicherheitszertifikat des Servers konnte nicht überprüft werden ({detail}), daher wurde Ihr Passwort nicht gesendet. Prüfen Sie, ob der Servername genau dem Ihres E-Mail-Anbieters entspricht, z. B. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Das Sicherheitszertifikat des Mailservers konnte nicht überprüft werden ({detail}), daher wurde das Postfach nicht abgerufen. Prüfen Sie den Servernamen unter Einstellungen → PQ Email.",
    ...
    # ── File locations dialog (issue #907) ──────────────────────────────────
    "action_file_locations": "OpenSAK-Dateispeicherorte…",
    "file_locations_title": "OpenSAK-Dateispeicherorte",
    "file_locations_intro": "OpenSAK speichert seine Einstellungen, Datenbanken und weitere Dateien an den unten aufgeführten Orten. Bei einer Deinstallation von OpenSAK bleiben Ihre Daten normalerweise erhalten — wenn Sie alles entfernen möchten, können Sie diese Ordner und Dateien nach der Deinstallation selbst löschen. Datenbanken, die von anderen Orten geöffnet wurden, werden nur zur Information angezeigt und niemals automatisch entfernt.",
    "file_locations_col_contents": "Inhalt",
    "file_locations_col_location": "Speicherort",
    "file_locations_col_exists": "Vorhanden",
    "file_locations_col_size": "Grösse",
    "file_locations_open_folder": "Ordner öffnen",
    "file_locations_copy_all": "Alles in die Zwischenablage kopieren",
    "file_locations_kind_install_dir": "Einstellungen und Programmdaten",
    "file_locations_kind_bootstrap_dir": "Startkonfiguration (verweist auf den Datenordner)",
    "file_locations_kind_database_dir": "Datenbankordner",
    "file_locations_kind_external_database": "Von einem anderen Ort geöffnete Datenbank",
    "file_locations_kind_qt_settings": "Ältere Einstellungen (Tastenkürzel)",
    "file_locations_kind_keyring_entry": "PQ-E-Mail-Passwort (System-Schlüsselbund)",
    "file_locations_kind_appimage_binary": "Programmdatei (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Eintrag im Anwendungsmenü",
    "file_locations_kind_appimage_icon": "Symbol im Anwendungsmenü",
}
