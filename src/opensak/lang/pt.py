...
STRINGS: dict[str, str] = {
    ...
    "wp_tab_personal":                         "Pessoal",
    "wp_cb_desc_html":                         "Contém HTML",
    "wp_val_elevation_invalid":                "A altitude deve ser um número (metros).",
    "wp_child_add":                            "Adicionar waypoint…",
    "wp_child_dialog_title_add":               "Adicionar waypoint",
    "wp_child_dialog_title_edit":              "Editar waypoint",
    "wp_child_col_prefix":                     "Prefixo",
    "wp_child_label_prefix":                   "Prefixo *:",
    "wp_child_label_comment":                  "Comentário:",
    "wp_child_label_code":                     "Código do waypoint:",
    "wp_child_label_date":                     "Data:",
    "wp_child_cb_flag":                        "Marcado",
    "wp_child_val_prefix_required":            "O prefixo é obrigatório.",
    "wp_child_val_code_duplicate":             "O código de waypoint {code} já é usado por outro waypoint desta cache.",
    ...
    "filter_invert":                "Inverter filtro",
    "filter_invert_tooltip":        "Mostrar exatamente as caches que este filtro ocultaria",
    ...
    "filter_tb_tracking_code":      "Código de rastreio",
    ...
    "filter_cc_distance":           "Distância corrigidas ↔ originais",
    "filter_op_less_than":          "Menos de",
    "filter_op_more_than":          "Mais de",
    "filter_op_not_between":        "Não entre",
    ...
    "filter_log_date":              "Data do registo",
    "filter_log_scope":             "Registos a pesquisar",
    "filter_log_scope_all":         "Todos os registos",
    "filter_log_scope_last_one":    "Último",
    "filter_log_scope_last":        "Últimos {n}",
    "filter_log_cat_other":         "Outros",
    "filter_log_include":           "Incluir / excluir",
    "filter_log_include_yes":       "Incluir",
    "filter_log_include_hint":      "Inclui ou exclui as caches para as quais as condições abaixo se verificam",
    "filter_log_types":             "Tipos de registo",
    "filter_log_types_all":         "Todos (desmarque para escolher tipos de registo individuais)",
    "filter_log_type_other":        '"Outros" (tipo não listado)',
    "filter_log_count":             "Quantidade necessária",
    "filter_log_count_any":         "Pelo menos um registo",
    "filter_log_finder":            "Registado por",
    "filter_log_finder_enable":     "e o registo é de uma pessoa específica",
    "filter_log_finder_by_id":      "Comparar o ID de utilizador",
    ...
    "startup_app_control_title":    "Bloqueado pelo Smart App Control do Windows",
    "startup_app_control_msg":      "O Smart App Control do Windows impediu o carregamento de uma parte do OpenSAK, por isso o OpenSAK não pode iniciar.\n\nIsto pode acontecer com a transferência direta a partir do GitHub. Instale antes o OpenSAK a partir da Microsoft Store (ver opensak.com) — essa versão é assinada pela Microsoft, não é bloqueada e mantém-se atualizada automaticamente.\n\n{error}\n\nFoi guardado um registo detalhado em:\n{path}",
    ...
    "pq_email_test_error_certificate": "✗ Não foi possível verificar o certificado de segurança do servidor ({detail}), pelo que a sua palavra-passe não foi enviada. Confirme que o nome do servidor é exatamente o indicado pelo seu fornecedor de email, p. ex. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Não foi possível verificar o certificado de segurança do servidor de email ({detail}), pelo que a caixa de correio não foi verificada. Confirme o nome do servidor em Configurações → PQ Email.",
    ...
    "action_file_locations": "Localizações dos ficheiros do OpenSAK…",
    "file_locations_title": "Localizações dos ficheiros do OpenSAK",
    "file_locations_intro": "O OpenSAK guarda as suas definições, bases de dados e outros ficheiros nas localizações abaixo. Ao desinstalar o OpenSAK, os seus dados são normalmente mantidos — se quiser remover tudo, pode apagar estas pastas e ficheiros manualmente após a desinstalação. As bases de dados abertas a partir de outras localizações são apresentadas apenas a título informativo e nunca são removidas automaticamente.",
    "file_locations_col_contents": "Conteúdo",
    "file_locations_col_location": "Localização",
    "file_locations_col_exists": "Existe",
    "file_locations_col_size": "Tamanho",
    "file_locations_open_folder": "Abrir pasta",
    "file_locations_copy_all": "Copiar tudo para a área de transferência",
    "file_locations_kind_install_dir": "Definições e dados da aplicação",
    "file_locations_kind_bootstrap_dir": "Configuração de arranque (aponta para a pasta de dados)",
    "file_locations_kind_database_dir": "Pasta das bases de dados",
    "file_locations_kind_external_database": "Base de dados aberta a partir de outra localização",
    "file_locations_kind_qt_settings": "Definições antigas (atalhos de teclado)",
    "file_locations_kind_keyring_entry": "Palavra-passe do PQ Email (porta-chaves do sistema)",
    "file_locations_kind_appimage_binary": "Ficheiro do programa (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Entrada no menu de aplicações",
    "file_locations_kind_appimage_icon": "Ícone no menu de aplicações",
}
