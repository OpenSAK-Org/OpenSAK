...
STRINGS: dict[str, str] = {
    ...
    "search_where_placeholder":     "e.g. distance < 5",
    "search_where_tooltip":         "SQL WHERE clause — same syntax as the Where tab in the filter dialog. Press Enter to apply, clear the box to remove it. Recently used expressions are in the dropdown.",
    "search_where_invalid":         "Invalid Where expression: {error}",
    ...
    "filter_cc_distance":           "Distance corrected ↔ posted",
    "filter_op_less_than":          "Less than",
    "filter_op_more_than":          "More than",
    "filter_op_not_between":        "Not between",
    ...
    "filter_tab_line_polygon":      "Line/Polygon",
    "filter_tab_waypoints":         "Child Waypoints",
    "filter_wp_code":               "Code",
    "filter_wp_date":               "Date",
    "filter_wp_comment":            "Comment",
    "filter_wp_by_user":            "Created by user",
    "filter_wp_count":              "Count",
    "filter_wp_count_at_least":     "At least",
    "filter_wp_count_at_most":      "At most",
    "filter_log_date":              "Log date",
    "filter_log_scope":             "Logs to search",
    "filter_log_scope_all":         "All logs",
    "filter_log_scope_last_one":    "Latest",
    "filter_log_scope_last":        "Last {n}",
    "filter_log_cat_other":         "Other",
    "filter_log_include":           "Include / exclude",
    "filter_log_include_yes":       "Include",
    "filter_log_include_hint":      "Includes or excludes caches for which the conditions below hold",
    "filter_log_types":             "Log types",
    "filter_log_types_all":         "All (uncheck to choose individual log types)",
    "filter_log_type_other":        '"Other" (unlisted type)',
    "filter_log_count":             "Required count",
    "filter_log_count_any":         "At least one log",
    "filter_log_finder":            "Logged by",
    "filter_log_finder_enable":     "and the log is by a specific person",
    "filter_log_finder_by_id":      "Match the user ID",
    "filter_lp_points_label":       "Line/polygon points",
    "filter_lp_points_placeholder": "Latitude, longitude — one point per line, e.g.\n53.18346, 8.71113\nN 53 23.613, E 008 00.941\n\nW,GC12345 uses the coordinates of a cache or waypoint in the database.\nText after # is ignored.",
    "filter_lp_add_flagged_btn":    "Add flagged (user flag)",
    "filter_lp_no_flagged":         "No caches have the user flag set.",
    "filter_lp_file_group":         "Read points from file",
    "filter_lp_choose_file_btn":    "Choose file…",
    "filter_lp_replace":            "Replace",
    "filter_lp_append":             "Append",
    "filter_lp_file_filter":        "Point files (*.gpx *.kml *.txt *.csv);;All files (*)",
    "filter_lp_file_error":         "Could not read the file:\n{error}",
    "filter_lp_file_no_points":     "No points found in the file.",
    "filter_lp_description":        "The line filter selects caches by how close they are to a line — a series of connected points, like a route or a track. Enter at least two points and the distance from the line within which caches are included.\n\nPolygon: the points outline an area (closed automatically, at least three points) and caches inside it are included. A distance greater than 0 also includes caches that close to the outline.\n\nPoints: caches within the distance of any of the points are included.\n\nCheck \"Exclude\" to keep only the caches that do not match instead. Corrected coordinates are used when set.",
    "filter_lp_type_group":         "Filter type",
    "filter_lp_type_line":          "Line",
    "filter_lp_type_polygon":       "Polygon",
    "filter_lp_type_points":        "Points",
    "filter_lp_distance_label":     "Distance:",
    "filter_lp_exclude":            "Exclude",
    "filter_lp_invalid_lines":      "These line/polygon points could not be read:\n{lines}",
    "filter_lp_too_few_points":     "The selected filter type needs at least {count} points.",
    "filter_lp_distance_required":  "Enter a distance greater than 0 for a line or points filter.",
    "filter_caches_with":           "Caches that have:",
    "filter_all_selected":          "ALL selected attributes",
    "filter_any_selected":          "ONE of the selected attributes",
    "filter_attr_col_name":         "Attribute",
    "filter_attr_search_placeholder": "Search attributes (name or ID)…",
    "filter_attr_only_selected":    "Show only selected",
    "filter_attr_status":           "{shown} of {total} shown · {selected} selected",
    ...
    "startup_app_control_title":    "Blocked by Windows Smart App Control",
    "startup_app_control_msg":      "Windows Smart App Control has blocked part of OpenSAK from loading, so OpenSAK cannot start.\n\nThis can happen with the direct download from GitHub. Please install OpenSAK from the Microsoft Store instead (see opensak.com) — that version is signed by Microsoft, is not blocked, and keeps itself up to date.\n\n{error}\n\nA detailed log has been saved to:\n{path}",
    ...
    "pq_email_test_error_certificate": "✗ The server's security certificate could not be verified ({detail}), so your password was not sent. Check that the server name is exactly the one your mail provider gives, e.g. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ The mail server's security certificate could not be verified ({detail}), so the mailbox was not checked. Check the server name under Settings → PQ Email.",
    ...
    "action_file_locations": "OpenSAK File Locations…",
    "file_locations_title": "OpenSAK File Locations",
    "file_locations_intro": "OpenSAK stores its settings, databases and other files in the locations below. Uninstalling OpenSAK normally leaves your data in place — if you want to remove everything, you can delete these folders and files yourself after uninstalling. Databases opened from other locations are listed for reference only and are never removed automatically.",
    "file_locations_col_contents": "Contents",
    "file_locations_col_location": "Location",
    "file_locations_col_exists": "Exists",
    "file_locations_col_size": "Size",
    "file_locations_open_folder": "Open folder",
    "file_locations_copy_all": "Copy all to clipboard",
    "file_locations_kind_install_dir": "Settings and application data",
    "file_locations_kind_bootstrap_dir": "Startup configuration (points to the data folder)",
    "file_locations_kind_database_dir": "Database folder",
    "file_locations_kind_external_database": "Database opened from another location",
    "file_locations_kind_qt_settings": "Legacy settings (keyboard shortcuts)",
    "file_locations_kind_keyring_entry": "PQ Email password (system keyring)",
    "file_locations_kind_appimage_binary": "Program file (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Application menu entry",
    "file_locations_kind_appimage_icon": "Application menu icon",
}
