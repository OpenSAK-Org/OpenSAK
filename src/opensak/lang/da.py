...
STRINGS: dict[str, str] = {
    ...
    "filter_invert":                "Inverter filter",
    "filter_invert_tooltip":        "Vis præcis de caches dette filter ville skjule",
    ...
    "filter_tb_tracking_code":      "Sporingskode",
    ...
    "filter_cc_distance":           "Afstand rettede ↔ oprindelige",
    "filter_op_less_than":          "Mindre end",
    "filter_op_more_than":          "Mere end",
    "filter_op_not_between":        "Ikke mellem",
    ...
    "filter_date_with_time":        "Klokkeslæt",
    ...
    "filter_tab_waypoints":         "Tilknyttede waypoints",
    "filter_wp_code":               "Kode",
    "filter_wp_date":               "Dato",
    "filter_wp_comment":            "Kommentar",
    "filter_wp_by_user":            "Oprettet af bruger",
    "filter_wp_count":              "Antal",
    "filter_wp_count_at_least":     "Mindst",
    "filter_wp_count_at_most":      "Højst",
    "filter_log_date":              "Log dato",
    "filter_log_scope":             "Logs der søges i",
    "filter_log_scope_all":         "Alle logs",
    "filter_log_scope_last_one":    "Seneste",
    "filter_log_scope_last":        "Seneste {n}",
    "filter_log_cat_other":         "Andre",
    "filter_log_include":           "Medtag / udeluk",
    "filter_log_include_yes":       "Medtag",
    "filter_log_include_hint":      "Medtager eller udelukker caches, hvor betingelserne nedenfor er opfyldt",
    "filter_log_types":             "Logtyper",
    "filter_log_types_all":         "Alle (fjern fluebenet for at vælge enkelte logtyper)",
    "filter_log_type_other":        '"Andre" (type ikke på listen)',
    "filter_log_count":             "Krævet antal",
    "filter_log_count_any":         "Mindst én log",
    "filter_log_finder":            "Logget af",
    "filter_log_finder_enable":     "og loggen er fra en bestemt person",
    "filter_log_finder_by_id":      "Match bruger-ID",
    ...
    "filter_attr_search_placeholder": "Søg attributter (navn eller ID)…",
    "filter_attr_only_selected":    "Vis kun valgte",
    "filter_attr_status":           "{shown} af {total} vist · {selected} valgt",
    ...
    "startup_app_control_title":    "Blokeret af Windows Smart App Control",
    "startup_app_control_msg":      "Windows Smart App Control har forhindret en del af OpenSAK i at blive indlæst, så OpenSAK kan ikke starte.\n\nDet kan ske med den direkte download fra GitHub. Installér i stedet OpenSAK fra Microsoft Store (se opensak.com) — den version er signeret af Microsoft, bliver ikke blokeret og holder sig selv opdateret.\n\n{error}\n\nEn detaljeret log er gemt her:\n{path}",
    ...
    "pq_email_test_error_certificate": "✗ Serverens sikkerhedscertifikat kunne ikke verificeres ({detail}), så dit kodeord blev ikke sendt. Kontrollér, at servernavnet er præcis det, din mailudbyder oplyser, fx imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Mailserverens sikkerhedscertifikat kunne ikke verificeres ({detail}), så postkassen blev ikke tjekket. Kontrollér servernavnet under Indstillinger → PQ Email.",
    ...
    "action_file_locations": "OpenSAK-filplaceringer…",
    "file_locations_title": "OpenSAK-filplaceringer",
    "file_locations_intro": "OpenSAK gemmer sine indstillinger, databaser og andre filer på placeringerne nedenfor. En afinstallation af OpenSAK lader normalt dine data blive liggende — hvis du vil fjerne alt, kan du selv slette disse mapper og filer efter afinstallationen. Databaser åbnet fra andre placeringer vises kun til orientering og fjernes aldrig automatisk.",
    "file_locations_col_contents": "Indhold",
    "file_locations_col_location": "Placering",
    "file_locations_col_exists": "Findes",
    "file_locations_col_size": "Størrelse",
    "file_locations_open_folder": "Åbn mappe",
    "file_locations_copy_all": "Kopiér alt til udklipsholderen",
    "file_locations_kind_install_dir": "Indstillinger og programdata",
    "file_locations_kind_bootstrap_dir": "Opstartskonfiguration (peger på datamappen)",
    "file_locations_kind_database_dir": "Databasemappe",
    "file_locations_kind_external_database": "Database åbnet fra en anden placering",
    "file_locations_kind_qt_settings": "Ældre indstillinger (tastaturgenveje)",
    "file_locations_kind_keyring_entry": "PQ Email-adgangskode (systemets nøglering)",
    "file_locations_kind_appimage_binary": "Programfil (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Punkt i programmenuen",
    "file_locations_kind_appimage_icon": "Ikon i programmenuen",
}
