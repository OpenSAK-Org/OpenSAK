...
STRINGS: dict[str, str] = {
    ...
    "filter_cc_distance":           "Vzdálenost opravené ↔ původní",
    "filter_op_less_than":          "Méně než",
    "filter_op_more_than":          "Více než",
    "filter_op_not_between":        "Není mezi",
    ...
    "filter_tab_waypoints":         "Podřízené waypointy",
    "filter_wp_code":               "Kód",
    "filter_wp_date":               "Datum",
    "filter_wp_comment":            "Komentář",
    "filter_wp_by_user":            "Vytvořeno uživatelem",
    "filter_wp_count":              "Počet",
    "filter_wp_count_at_least":     "Alespoň",
    "filter_wp_count_at_most":      "Nejvýše",
    "filter_log_date":              "Datum logu",
    "filter_log_scope":             "Prohledávané logy",
    "filter_log_scope_all":         "Všechny logy",
    "filter_log_scope_last_one":    "Poslední",
    "filter_log_scope_last":        "Posledních {n}",
    "filter_log_cat_other":         "Ostatní",
    "filter_log_include":           "Zahrnout / vyloučit",
    "filter_log_include_yes":       "Zahrnout",
    "filter_log_include_hint":      "Zahrne nebo vyloučí kešky, pro které platí níže uvedené podmínky",
    "filter_log_types":             "Typy logů",
    "filter_log_types_all":         "Vše (odškrtnutím vyberete jednotlivé typy logů)",
    "filter_log_type_other":        '"Ostatní" (typ mimo seznam)',
    "filter_log_count":             "Požadovaný počet",
    "filter_log_count_any":         "Alespoň jeden log",
    "filter_log_finder":            "Zapsal",
    "filter_log_finder_enable":     "a log je od určité osoby",
    "filter_log_finder_by_id":      "Porovnat ID uživatele",
    ...
    "filter_attr_search_placeholder": "Hledat atributy (název nebo ID)…",
    "filter_attr_only_selected":    "Zobrazit jen vybrané",
    "filter_attr_status":           "Zobrazeno {shown} z {total} · vybráno {selected}",
    ...
    "update_download_button":       "Stáhnout a nainstalovat",
    "update_downloading_title":     "Stahuje se aktualizace",
    "update_downloading":           "Stahuje se nová verze…",
    ...
    "pq_email_test_error_certificate": "✗ Bezpečnostní certifikát serveru nelze ověřit ({detail}), proto vaše heslo nebylo odesláno. Zkontrolujte, že název serveru přesně odpovídá údaji od vašeho poskytovatele e-mailu, např. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Bezpečnostní certifikát poštovního serveru nelze ověřit ({detail}), proto schránka nebyla zkontrolována. Zkontrolujte název serveru v Nastavení → PQ Email.",
    ...
    "action_file_locations": "Umístění souborů OpenSAK…",
    "file_locations_title": "Umístění souborů OpenSAK",
    "file_locations_intro": "OpenSAK ukládá svá nastavení, databáze a další soubory do níže uvedených umístění. Při odinstalaci OpenSAK zůstanou vaše data obvykle zachována — pokud chcete odstranit vše, můžete tyto složky a soubory po odinstalaci smazat sami. Databáze otevřené z jiných umístění jsou uvedeny pouze pro informaci a nikdy nejsou odstraněny automaticky.",
    "file_locations_col_contents": "Obsah",
    "file_locations_col_location": "Umístění",
    "file_locations_col_exists": "Existuje",
    "file_locations_col_size": "Velikost",
    "file_locations_open_folder": "Otevřít složku",
    "file_locations_copy_all": "Zkopírovat vše do schránky",
    "file_locations_kind_install_dir": "Nastavení a data aplikace",
    "file_locations_kind_bootstrap_dir": "Konfigurace spuštění (odkazuje na složku s daty)",
    "file_locations_kind_database_dir": "Složka databází",
    "file_locations_kind_external_database": "Databáze otevřená z jiného umístění",
    "file_locations_kind_qt_settings": "Starší nastavení (klávesové zkratky)",
    "file_locations_kind_keyring_entry": "Heslo PQ Email (systémová klíčenka)",
    "file_locations_kind_appimage_binary": "Soubor programu (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Položka v nabídce aplikací",
    "file_locations_kind_appimage_icon": "Ikona v nabídce aplikací",
}
