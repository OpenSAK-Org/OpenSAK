...
STRINGS: dict[str, str] = {
    ...
    "filter_log_include":           "Ein-/Ausschließen",
    "filter_log_include_yes":       "Einschließen",
    "filter_log_include_hint":      "Schließt Geocaches im Filter ein/aus, falls die folgenden Bedingungen zutreffen",
    ...
    "update_download_done_msg":     "Die neue Version wurde heruntergeladen und für Sie geöffnet. Schließen Sie OpenSAK und schließen Sie die Installation von dort ab.",
    "update_download_saved_msg_mac": "Das Update konnte nicht automatisch installiert werden und wurde stattdessen für Sie geöffnet: Ziehen Sie OpenSAK in den Ordner Programme, um die Installation abzuschließen. Die heruntergeladene Datei befindet sich in Ihrem Downloads-Ordner:\n{path}",
