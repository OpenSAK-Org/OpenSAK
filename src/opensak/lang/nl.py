...
STRINGS: dict[str, str] = {
    ...
    "wp_tab_personal":                         "Persoonlijk",
    "wp_cb_desc_html":                         "Bevat HTML",
    "wp_val_elevation_invalid":                "Hoogte moet een getal zijn (meter).",
    "wp_child_add":                            "Waypoint toevoegen…",
    "wp_child_dialog_title_add":               "Waypoint toevoegen",
    "wp_child_dialog_title_edit":              "Waypoint bewerken",
    "wp_child_col_prefix":                     "Prefix",
    "wp_child_label_prefix":                   "Prefix *:",
    "wp_child_label_comment":                  "Opmerking:",
    "wp_child_label_code":                     "Waypointcode:",
    "wp_child_label_date":                     "Datum:",
    "wp_child_cb_flag":                        "Gemarkeerd",
    "wp_child_val_prefix_required":            "Prefix is verplicht.",
    "wp_child_val_code_duplicate":             "Waypointcode {code} wordt al gebruikt door een ander waypoint van deze cache.",
    ...
    "filter_invert":                "Filter omkeren",
    "filter_invert_tooltip":        "Toon precies de caches die dit filter zou verbergen",
    ...
    "filter_cc_distance":           "Afstand gecorrigeerd ↔ origineel",
    "filter_op_less_than":          "Minder dan",
    "filter_op_more_than":          "Meer dan",
    "filter_op_not_between":        "Niet tussen",
    ...
    "filter_log_scope":             "Te doorzoeken logs",
    "filter_log_scope_all":         "Alle logs",
    "filter_log_scope_last_one":    "Laatste",
    "filter_log_scope_last":        "Laatste {n}",
    "filter_log_cat_other":         "Overige",
    "filter_log_include":           "Opnemen / uitsluiten",
    "filter_log_include_yes":       "Opnemen",
    "filter_log_include_hint":      "Neemt caches op of sluit ze uit waarvoor de onderstaande voorwaarden gelden",
    "filter_log_types":             "Logtypen",
    "filter_log_types_all":         "Alle (vink uit om afzonderlijke logtypen te kiezen)",
    "filter_log_type_other":        '"Overige" (type niet in de lijst)',
    "filter_log_count":             "Vereist aantal",
    "filter_log_count_any":         "Minstens één log",
    "filter_log_finder":            "Gelogd door",
    "filter_log_finder_enable":     "en de log is van een bepaalde persoon",
    "filter_log_finder_by_id":      "Op gebruikers-ID",
    ...
    "startup_app_control_title":    "Geblokkeerd door Windows Smart App Control",
    "startup_app_control_msg":      "Windows Smart App Control heeft verhinderd dat een deel van OpenSAK werd geladen, dus OpenSAK kan niet starten.\n\nDit kan gebeuren met de directe download van GitHub. Installeer OpenSAK in plaats daarvan via de Microsoft Store (zie opensak.com) — die versie is ondertekend door Microsoft, wordt niet geblokkeerd en houdt zichzelf up-to-date.\n\n{error}\n\nEen gedetailleerd logbestand is opgeslagen in:\n{path}",
    ...
    "update_download_button":       "Downloaden & installeren",
    "update_downloading_title":     "Update wordt gedownload",
    "update_downloading":           "De nieuwe versie wordt gedownload…",
    ...
    "pq_email_test_error_certificate": "✗ Het beveiligingscertificaat van de server kon niet worden geverifieerd ({detail}), dus uw wachtwoord is niet verzonden. Controleer of de servernaam precies is wat uw e-mailprovider opgeeft, bijv. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Het beveiligingscertificaat van de mailserver kon niet worden geverifieerd ({detail}), dus de mailbox is niet gecontroleerd. Controleer de servernaam onder Instellingen → PQ Email.",
    ...
    "action_file_locations": "OpenSAK-bestandslocaties…",
    "file_locations_title": "OpenSAK-bestandslocaties",
    "file_locations_intro": "OpenSAK slaat zijn instellingen, databases en andere bestanden op in de onderstaande locaties. Bij het verwijderen van OpenSAK blijven je gegevens normaal gesproken bewaard — wil je alles verwijderen, dan kun je deze mappen en bestanden na het verwijderen zelf wissen. Databases die vanaf andere locaties zijn geopend, worden alleen ter informatie getoond en nooit automatisch verwijderd.",
    "file_locations_col_contents": "Inhoud",
    "file_locations_col_location": "Locatie",
    "file_locations_col_exists": "Bestaat",
    "file_locations_col_size": "Grootte",
    "file_locations_open_folder": "Map openen",
    "file_locations_copy_all": "Alles naar het klembord kopiëren",
    "file_locations_kind_install_dir": "Instellingen en programmagegevens",
    "file_locations_kind_bootstrap_dir": "Opstartconfiguratie (verwijst naar de gegevensmap)",
    "file_locations_kind_database_dir": "Databasemap",
    "file_locations_kind_external_database": "Database geopend vanaf een andere locatie",
    "file_locations_kind_qt_settings": "Oudere instellingen (sneltoetsen)",
    "file_locations_kind_keyring_entry": "PQ Email-wachtwoord (sleutelhanger van het systeem)",
    "file_locations_kind_appimage_binary": "Programmabestand (AppImage)",
