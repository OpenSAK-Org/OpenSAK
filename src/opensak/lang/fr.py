...
STRINGS: dict[str, str] = {
    ...
    "search_where_tooltip":         "Clause SQL WHERE — même syntaxe que l'onglet Where de la boîte de filtre. Entrée pour appliquer, videz le champ pour la retirer. Les expressions récentes sont dans la liste.",
    "search_where_invalid":         "Expression Where invalide : {error}",
    ...
    "wp_tab_personal":                         "Personnel",
    "wp_cb_desc_html":                         "Contient du HTML",
    "wp_val_elevation_invalid":                "L'altitude doit être un nombre (mètres).",
    "wp_child_add":                            "Ajouter un waypoint…",
    "wp_child_dialog_title_add":               "Ajouter un waypoint",
    "wp_child_dialog_title_edit":              "Modifier le waypoint",
    "wp_child_col_prefix":                     "Préfixe",
    "wp_child_label_prefix":                   "Préfixe * :",
    "wp_child_label_comment":                  "Commentaire :",
    "wp_child_label_code":                     "Code du waypoint :",
    "wp_child_label_date":                     "Date :",
    "wp_child_cb_flag":                        "Marqué",
    "wp_child_val_prefix_required":            "Le préfixe est obligatoire.",
    "wp_child_val_code_duplicate":             "Le code de waypoint {code} est déjà utilisé par un autre waypoint de cette cache.",
    ...
    "filter_invert":                "Inverser le filtre",
    "filter_invert_tooltip":        "Afficher exactement les caches que ce filtre masquerait",
    ...
    "filter_tb_tracking_code":      "Code de suivi",
    ...
    "filter_cc_distance":           "Distance corrigées ↔ d'origine",
    "filter_op_less_than":          "Moins de",
    "filter_op_more_than":          "Plus de",
    "filter_op_not_between":        "Pas entre",
    ...
    "filter_tab_line_polygon":      "Ligne/Polygone",
    "filter_tab_waypoints":         "Waypoints secondaires",
    "filter_wp_code":               "Code",
    "filter_wp_date":               "Date",
    "filter_wp_comment":            "Commentaire",
    "filter_wp_by_user":            "Créé par l'utilisateur",
    "filter_wp_count":              "Nombre",
    "filter_wp_count_at_least":     "Au moins",
    "filter_wp_count_at_most":      "Au plus",
    "filter_log_date":              "Date du log",
    "filter_log_scope":             "Logs à rechercher",
    "filter_log_scope_all":         "Tous les logs",
    "filter_log_scope_last_one":    "Dernier",
    "filter_log_scope_last":        "{n} derniers",
    "filter_log_cat_other":         "Autres",
    "filter_log_include":           "Inclure / exclure",
    "filter_log_include_yes":       "Inclure",
    "filter_log_include_hint":      "Inclut ou exclut les caches pour lesquelles les conditions ci-dessous sont remplies",
    "filter_log_types":             "Types de log",
    "filter_log_types_all":         "Tous (décocher pour choisir des types de log individuels)",
    "filter_log_type_other":        '"Autres" (type absent de la liste)',
    "filter_log_count":             "Nombre requis",
    "filter_log_count_any":         "Au moins un log",
    "filter_log_finder":            "Loggé par",
    "filter_log_finder_enable":     "et le log est d'une personne précise",
    "filter_log_finder_by_id":      "Comparer l'ID utilisateur",
    "filter_lp_points_label":       "Points de la ligne/du polygone",
    "filter_lp_points_placeholder": "Latitude, longitude — un point par ligne, p. ex.\n53.18346, 8.71113\nN 53 23.613, E 008 00.941\n\nW,GC12345 utilise les coordonnées d'une cache ou d'un waypoint de la base de données.\nLe texte après # est ignoré.",
    "filter_lp_add_flagged_btn":    "Ajouter les marquées (user flag)",
    "filter_lp_no_flagged":         "Aucune cache n'a le user flag activé.",
    "filter_lp_file_group":         "Lire les points depuis un fichier",
    "filter_lp_choose_file_btn":    "Choisir un fichier…",
    "filter_lp_replace":            "Remplacer",
    "filter_lp_append":             "Ajouter à la suite",
    "filter_lp_file_filter":        "Fichiers de points (*.gpx *.kml *.txt *.csv);;Tous les fichiers (*)",
    "filter_lp_file_error":         "Impossible de lire le fichier :\n{error}",
    "filter_lp_file_no_points":     "Aucun point trouvé dans le fichier.",
    "filter_lp_description":        "Le filtre ligne sélectionne les caches selon leur proximité d'une ligne — une suite de points reliés, comme un itinéraire ou une trace. Saisissez au moins deux points et la distance à la ligne en deçà de laquelle les caches sont retenues.\n\nPolygone : les points délimitent une zone (fermée automatiquement, au moins trois points) et les caches à l'intérieur sont retenues. Une distance supérieure à 0 retient aussi les caches aussi proches du contour.\n\nPoints : les caches situées à moins de cette distance de l'un des points sont retenues.\n\nCochez « Exclure » pour ne garder à la place que les caches qui ne correspondent pas. Les coordonnées corrigées sont utilisées lorsqu'elles existent.",
    "filter_lp_type_group":         "Type de filtre",
    "filter_lp_type_line":          "Ligne",
    "filter_lp_type_polygon":       "Polygone",
    "filter_lp_type_points":        "Points",
    "filter_lp_distance_label":     "Distance :",
    "filter_lp_exclude":            "Exclure",
    "filter_lp_invalid_lines":      "Ces points de ligne/polygone n'ont pas pu être lus :\n{lines}",
    "filter_lp_too_few_points":     "Le type de filtre choisi nécessite au moins {count} points.",
    "filter_lp_distance_required":  "Saisissez une distance supérieure à 0 pour un filtre ligne ou points.",
    "filter_caches_with":           "Caches qui ont:",
    "filter_all_selected":          "TOUS les attributs sélectionnés",
    "filter_any_selected":          "UN des attributs sélectionnés",
    "filter_attr_col_name":         "Attribut",
    "filter_attr_search_placeholder": "Rechercher un attribut (nom ou ID)…",
    "filter_attr_only_selected":    "Afficher la sélection uniquement",
    "filter_attr_status":           "{shown} sur {total} affichés · {selected} sélectionnés",
    ...
    "filter_overwrite_title":       "Écraser le profil",
    "filter_overwrite_msg":         "Le profil de filtre '{name}' existe déjà. Voulez-vous l'écraser ?",
    ...
    "startup_app_control_title":    "Bloqué par le Contrôle intelligent des applications de Windows",
    "startup_app_control_msg":      "Le Contrôle intelligent des applications de Windows (Smart App Control) a empêché le chargement d'une partie d'OpenSAK ; OpenSAK ne peut donc pas démarrer.\n\nCela peut arriver avec le téléchargement direct depuis GitHub. Installez plutôt OpenSAK depuis le Microsoft Store (voir opensak.com) : cette version est signée par Microsoft, n'est pas bloquée et se met à jour automatiquement.\n\n{error}\n\nUn journal détaillé a été enregistré ici :\n{path}",
    ...
    "update_download_button":       "Télécharger et installer",
    "update_downloading_title":     "Téléchargement de la mise à jour",
    "update_downloading":           "Téléchargement de la nouvelle version…",
    ...
    "pq_email_test_error_certificate": "✗ Le certificat de sécurité du serveur n'a pas pu être vérifié ({detail}) ; votre mot de passe n'a donc pas été envoyé. Vérifiez que le nom du serveur est exactement celui indiqué par votre fournisseur de messagerie, par ex. imap.example.com.",
    ...
    "pq_check_error_certificate": "✗ Le certificat de sécurité du serveur de messagerie n'a pas pu être vérifié ({detail}) ; la boîte aux lettres n'a donc pas été consultée. Vérifiez le nom du serveur dans Paramètres → Email PQ.",
    ...
    "action_file_locations": "Emplacements des fichiers OpenSAK…",
    "file_locations_title": "Emplacements des fichiers OpenSAK",
    "file_locations_intro": "OpenSAK enregistre ses paramètres, ses bases de données et d'autres fichiers aux emplacements ci-dessous. La désinstallation d'OpenSAK conserve normalement vos données — si vous souhaitez tout supprimer, vous pouvez effacer vous-même ces dossiers et fichiers après la désinstallation. Les bases de données ouvertes depuis d'autres emplacements sont indiquées à titre informatif et ne sont jamais supprimées automatiquement.",
    "file_locations_col_contents": "Contenu",
    "file_locations_col_location": "Emplacement",
    "file_locations_col_exists": "Existe",
    "file_locations_col_size": "Taille",
    "file_locations_open_folder": "Ouvrir le dossier",
    "file_locations_copy_all": "Tout copier dans le presse-papiers",
    "file_locations_kind_install_dir": "Paramètres et données de l'application",
    "file_locations_kind_bootstrap_dir": "Configuration de démarrage (pointe vers le dossier de données)",
    "file_locations_kind_database_dir": "Dossier des bases de données",
    "file_locations_kind_external_database": "Base de données ouverte depuis un autre emplacement",
    "file_locations_kind_qt_settings": "Anciens paramètres (raccourcis clavier)",
    "file_locations_kind_keyring_entry": "Mot de passe PQ Email (trousseau du système)",
    "file_locations_kind_appimage_binary": "Fichier du programme (AppImage)",
    "file_locations_kind_appimage_desktop_file": "Entrée du menu des applications",
    "file_locations_kind_appimage_icon": "Icône du menu des applications",
}
